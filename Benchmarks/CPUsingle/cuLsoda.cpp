...
int dlsoda_(Fex f, int *neq, REAL *y, REAL *t, REAL *tout, int *itol, REAL *rtol, REAL *atol, int *itask, int *istate, int *iopt, REAL *rwork, int *lrw, int *iwork, int *liw, Jex jac, int *jt, struct cuLsodaCommonBlock *common)
{
    /* Initialized data */
...
/* DECK DCFODE */
/* Subroutine */ 
int dcfode_(int PARAM_meth, REAL *DCFODE_elco, REAL *DCFODE_tesco, struct cuLsodaCommonBlock *common)
{
    /* System generated locals */
    int i__1 = 0;
